...
int main(int argc, char *argv[]){
    ...
    while(true){
        ...
        if(SDL_PollEvent(&windowEvent)){
            ...
            // mouse down and white turn
            else if (windowEvent.type == SDL_MOUSEBUTTONDOWN && game.isWhiteTurn()) {
                ...
                if(selectedPiece != PieceType::EMPTY && pieceTypeToString(selectedPiece)[0] != 'B'){
            ...
            // mouse down and black turn
                ...
                // make sure that a valid piece was selected
                if(selectedPiece != PieceType::EMPTY && pieceTypeToString(selectedPiece)[0] != 'W'){
                    std::cout << "Selected " << pieceTypeToString(selectedPiece) << " at: " << row << ", " << col << endl;
                    // cout << "Selected Bit Pos: " << bitPos << endl;
                    // chessBoard.printU64(mask);
                }
            ...
            // mouse release and white turn
            else if (windowEvent.type == SDL_MOUSEBUTTONUP && game.isWhiteTurn()) {
            ...
            // if(game.isCheck(game.isWhiteTurn())) {
